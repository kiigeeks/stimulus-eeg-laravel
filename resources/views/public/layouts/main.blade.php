...
<html>
    ...
    <body class="hidden lg:block">
        <header class="w-full pt-20 flex flex-col gap-7 justify-center items-center font-poppins text-gray-800 relative">
            ...
            <div id="counter" class="absolute right-10 top-7 w-14 h-14 rounded-full bg-white shadow-xl border border-gray-300 flex justify-center items-center p-4 text-gray-900 text-xl font-bold"> 
            </div>
        </header>
